...
export const SCHOLARSHIPS_DATA: Scholarship[] = [
  // 1. FUNDACIÓN CAROLINA
  {
    ...
    isUrgent: true,
    description:
      "Financia estudios de máster y posgrados en universidades públicas y privadas de España para graduados de la Comunidad Iberoamericana de Naciones.",
    requirements: [
  ...
  // 2. UNIVERSIDAD DE SALAMANCA (USAL)
  {
    ...
    isUrgent: false,
    description:
      "La Universidad de Salamanca otorga becas completas de máster para estudiantes iberoamericanos con excelencia académica, incluyendo exención total de matrícula y alojamiento en colegios mayores.",
    requirements: [
  ...
  // 3. ASOCIACIÓN UNIVERSITARIA IBEROAMERICANA DE POSGRADO (AUIP)
  {
    ...
    isUrgent: false,
    description:
      "Programa conjunto entre la AUIP y la Junta de Andalucía para facilitar que titulados latinoamericanos cursen másteres oficiales en universidades andaluzas con ayuda de traslado y matrícula subvencionada.",
    requirements: [
  ...
  // 4. DAAD ALEMANIA
  {
    ...
    isUrgent: false,
    description:
      "El Servicio Alemán de Intercambio Académico (DAAD) financia másteres en Gobernanza, Políticas Públicas y Desarrollo para futuros líderes latinoamericanos.",
    requirements: [
  ...
  // 5. ETH ZURICH (SUIZA)
  {
    ...
    isUrgent: false,
    description:
      "ETH Zurich premia a los estudiantes de máster con los mejores expedientes del mundo con una beca completa que cubre matrícula, manutención y tutoría de investigación.",
    requirements: [
  ...
  // 6. ERASMUS MUNDUS (UNIÓN EUROPEA)
  {
    ...
    isUrgent: false,
    description:
      "Másteres internacionales conjuntos de excelencia impartidos por al menos tres universidades europeas de países distintos, con título múltiple y financiación 100% comunitaria.",
    requirements: [
  ...
  // 7. POLIMI / INVEST YOUR TALENT IN ITALY (ITALIA)
  {
    ...
    isUrgent: false,
    description:
      "Programa del Ministerio de Relaciones Exteriores de Italia y universidades italianas que combina beca académica de máster en inglés con una pasantía profesional remunerada en empresas italianas.",
    requirements: [
  ...
  // 8. CAMPUS FRANCE / BECAS EIFFEL (FRANCIA)
  {
    ...
    isUrgent: false,
    description:
      "Herramienta desarrollada por el Ministerio para Europa y de Asuntos Exteriores de Francia para permitir que las universidades francesas atraigan a los mejores estudiantes extranjeros a formaciones de Máster y Doctorado.",
    requirements: [
  ...
  // 9. PAÍSES BAJOS - NL SCHOLARSHIP (TU DELFT / UNIV AMSTERDAM)
  {
    ...
    isUrgent: false,
    description:
      "Financiada por el Ministerio de Educación, Cultura y Ciencia de los Países Bajos junto con universidades de investigación neerlandesas para estudiantes internacionales no pertenecientes al EEE.",
    requirements: [
  ...
  // 10. SUECIA - KAROLINSKA INSTITUTET (SALUD / MEDICINA)
  {
    ...
    isUrgent: false,
    description:
      "El prestigioso Instituto Karolinska en Estocolmo ofrece exención de matrícula a estudiantes con expedientes sobresalientes en Salud Pública, Biomedicina, Toxicología y Ciencias de la Salud.",
    requirements: [
  ...
  // 11. REINO UNIDO - GATES CAMBRIDGE
  {
    ...
    isUrgent: false,
    description:
      "Creada por donación de la Fundación Bill y Melinda Gates, financia programas completos de posgrado en Cambridge para personas comprometidas a mejorar la vida de los demás.",
    requirements: [
  ...
  // 12. CHEVENING REINO UNIDO
  {
    ...
    isUrgent: false,
    description:
      "Programa mundial de becas del gobierno británico financiado por el Foreign, Commonwealth & Development Office para formar a los futuros líderes mundiales.",
    requirements: [
  ...
  // 13. ESTADOS UNIDOS - FULBRIGHT
  {
    ...
    isUrgent: false,
    description:
      "Programa insigne del gobierno de EE.UU. para jóvenes profesionales y académicos latinoamericanos que desean realizar estudios de máster o doctorado.",
    requirements: [
  ...
  // 14. CANADÁ - UNIVERSITY OF TORONTO LESTER B. PEARSON
  {
    ...
    isUrgent: false,
    description:
      "Reconoce a estudiantes internacionales excepcionales que demuestran un rendimiento académico sobresaliente y creatividad, considerados líderes dentro de sus escuelas y comunidades.",
    requirements: [
  ...
  // 15. CANADÁ - VANIER DOCTORAL
  {
    ...
    isUrgent: true,
    description:
      "Atrae a los estudiantes de doctorado más cualificados del mundo en salud, ciencias naturales, ingeniería, ciencias sociales y humanidades.",
    requirements: [
  ...
  // 16. OEA - PAEC
  {
    ...
    isUrgent: false,
    description:
      "La Organización de los Estados Americanos (OEA) apoya a ciudadanos de Estados miembros con descuentos en colegiaturas del 50% al 100% para maestrías y doctorados.",
    requirements: [
  ...
  // 17. SANTANDER OPEN ACADEMY
  {
    ...
    isUrgent: false,
    description:
      "Banco Santander impulsa la formación continua y la movilidad estudiantil de jóvenes de América Latina hacia España, Portugal y Latinoamérica con ayudas de matrícula e intercambios.",
    requirements: [
  ...
  // 18. PORTUGAL - FCT DOCTORAL
  {
    ...
    institution:
      "Fundação para a Ciência e a Tecnologia (FCT) / Universidades de Lisboa, Porto y Coímbra",
    institutionType: "Gubernamental",
    ...
    isUrgent: false,
    description:
      "La Fundación para la Ciencia y Tecnología de Portugal ofrece becas anuales de doctorado completas en todas las áreas del conocimiento para investigadores internacionales con dedicación exclusiva.",
    requirements: [
  ...
  // 19. PORTUGAL - CAMÕES LÍNGUA E CULTURA
  {
    ...
    isUrgent: false,
    description:
      "Financia estudios de especialización, posgrado y formación avanzada en lengua portuguesa, cultura lusófona, traducción y cooperación internacional.",
    requirements: [
  ...
  // 20. AUSTRALIA - RESEARCH TRAINING PROGRAM (RTP)
  {
    ...
    isUrgent: true,
    description:
      "El programa RTP del gobierno australiano otorga becas completas de maestría por investigación (2 años) y doctorado PhD (hasta 4 años) a talentos internacionales de excelencia.",
    requirements: [
  ...
  // 21. AUSTRALIA - DESTINATION AUSTRALIA REGIONAL
  {
    ...
    isUrgent: false,
    description:
      "Incentiva a estudiantes nacionales e internacionales a cursar programas de Pregrado (Bachelor) y Diplomas en campus regionales de Australia, sumando puntos prioritarios para residencia permanente.",
    requirements: [
  ...
  // 22. MARIE SKŁODOWSKA-CURIE (POSTDOCTORADO - EUROPA)
  {
    ...
    isUrgent: true,
    description:
      "El programa estrella de la Unión Europea para investigadores con doctorado que desean desarrollar estancias postdoctorales avanzadas en universidades de España, Portugal, Alemania o cualquier país de la UE.",
    requirements: [
