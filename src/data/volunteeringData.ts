export interface VolunteeringProgram {
  ...
  country: string;
  countryCode: string;
  category: "Voluntariado" | "Intercambio Cultural" | "Au Pair" | "Work & Travel / Working Holiday" | "Asistente de Idioma";
  duration: string;
  financialSupport: "Alojamiento y Comida incluidos" | "Estipendio Mensual + Alojamiento" | "Beca Completa" | "Auto-financiado / Tarifa Base";
  visaType: string;
...
export const VOLUNTEERING_PROGRAMS_DATA: VolunteeringProgram[] = [
  {
    ...
    importantDisclaimer: "⚠️ Este programa NO otorga residencia permanente ni permiso de trabajo por cuenta ajena. Es exclusivamente para servicio comunitario voluntario y aprendizaje intercultural.",
    targetAudience: "Jóvenes de 18 a 30 años (incluye países asociados de América Latina en convenios específicos)",
    description: "Iniciativa de la Unión Europea que financia proyectos de voluntariado en ONG, protección medioambiental, educación infantil, inclusión social y centros juveniles.",
    requirements: [
  ...
  },
  {
    ...
    importantDisclaimer: "⚠️ Diseñado para desarrollo de liderazgo y proyectos alineados con los ODS de la ONU. NO es una vía de inmigración laboral ni de residencia a largo plazo.",
    targetAudience: "Estudiantes universitarios y recién graduados de 18 a 29 años",
    description: "Proyectos de voluntariado internacional enfocados en educación de idiomas a niños desfavorecidos, conservación ecológica, empoderamiento femenino y salud pública.",
    requirements: [
  ...
  },
  {
    ...
    importantDisclaimer: "⚠️ Intercambio de 20-25 horas semanales de ayuda (recepción de hostel, eco-granjas, fotografía) a cambio de techo y comida. No se percibe salario ni sustituye un visado de trabajo legal.",
    targetAudience: "Viajeros culturales, nómadas y exploradores de cualquier edad (+18)",
    description: "Plataformas globales que conectan a viajeros con eco-aldeas, granjas orgánicas, escuelas comunitarias y hostales para vivir una experiencia inmersiva económica.",
    requirements: [
  ...
  },
  {
    ...
    importantDisclaimer: "⚠️ Permite viajar y realizar trabajos temporales remunerados para costear las vacaciones. NO es una visa de patrocinio profesional directo, aunque permite conocer el mercado laboral australiano y ahorrar.",
    targetAudience: "Jóvenes de 18 a 30 años de países latinoamericanos con convenio (Argentina, Chile, Perú, Uruguay, Ecuador)",
    description: "Visa bilateral que permite a jóvenes latinoamericanos viajar por Australia durante un año entero, trabajando hasta 6 meses con un mismo empleador en hostelería, agricultura, turismo o servicios.",
    requirements: [
  ...
  },
  {
    ...
    importantDisclaimer: "⚠️ Se colabora como asistente en centros educativos de primaria y secundaria. Otorga asignación mensual libre de impuestos, pero es una estancia temporal de formación docente.",
    targetAudience: "Graduados universitarios o estudiantes de último año",
    description: "Programa oficial que asigna a asistentes en colegios públicos españoles para impartir clases de conversación (14-16 horas por semana) recibiendo una mensualidad.",
    requirements: [
  ...
  },
  {
    ...
    importantDisclaimer: "⚠️ Es una estancia de convivencia familiar donde se cuida a los niños de la casa a cambio de alojamiento, comida y dinero de bolsillo. NO es empleo doméstico formal ordinario.",
    targetAudience: "Jóvenes de 18 a 26/30 años solteros y sin hijos",
    description: "Vivir con una familia anfitriona europea, cuidando a sus hijos hasta 30h semanales y asistiendo a academias de idiomas locales con gastos básicos resueltos.",
    requirements: [
