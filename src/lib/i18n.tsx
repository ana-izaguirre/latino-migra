...
export const TRANSLATIONS: TranslationDictionary = {
  ...
  "estudios.addFavourite": { es: "Guardar este programa", en: "Save this programme" },
  "estudios.removeFavourite": { es: "Quitar de mis guardados", en: "Remove from saved" },
  "becas.tabSaved": { es: "Mis Guardados", en: "My Saved Items" },
  "becas.savedHeading": { es: "Sección: Mis Guardados", en: "Section: My saved items" },
  "becas.savedIntro": {
  ...
  // Values the catalogues store, shown to the reader (see lib/labels.ts)
  "label.country.all": { es: "🌍 Todos", en: "🌍 All" },
  "label.country.es": { es: "España", en: "Spain" },
  "label.country.pt": { es: "Portugal", en: "Portugal" },
  "label.country.de": { es: "Alemania", en: "Germany" },
  "label.country.fr": { es: "Francia", en: "France" },
  "label.country.it": { es: "Italia", en: "Italy" },
  "label.country.nl": { es: "Países Bajos", en: "Netherlands" },
  "label.country.ch": { es: "Suiza", en: "Switzerland" },
  "label.country.se": { es: "Suecia", en: "Sweden" },
  "label.country.uk": { es: "Reino Unido", en: "United Kingdom" },
  "label.country.us": { es: "Estados Unidos", en: "United States" },
  "label.country.ca": { es: "Canadá", en: "Canada" },
  "label.country.au": { es: "Australia", en: "Australia" },
  "label.country.ie": { es: "Irlanda", en: "Ireland" },
  "label.country.eu": { es: "Unión Europea", en: "European Union" },
  "label.area.all": { es: "✨ Todas", en: "✨ All" },
  "label.area.stem": { es: "STEM", en: "STEM" },
  "label.area.arts": { es: "Artes y Humanidades", en: "Arts and Humanities" },
  "label.area.health": { es: "Salud", en: "Health" },
  "label.area.business": { es: "Negocios", en: "Business" },
  "label.area.any": { es: "Abierta a cualquier área", en: "Open to any field" },
  "label.support.all": { es: "🏆 Todos", en: "🏆 All" },
  "label.support.full": { es: "Beca Completa", en: "Full Scholarship" },
  "label.support.partial": { es: "Beca Parcial", en: "Partial Scholarship" },
  "label.support.stipend": { es: "Manutención", en: "Living Stipend" },
  "label.institution.all": { es: "🏛️ Todas", en: "🏛️ All" },
  "label.institution.university": { es: "Universidad Directa", en: "University Direct" },
  "label.institution.government": { es: "Gubernamental", en: "Government" },
  "label.institution.international": { es: "Organismo Internacional", en: "International Body" },
  "label.institution.foundation": { es: "Fundación", en: "Foundation" },
  "label.level.all": { es: "🎓 Todos", en: "🎓 All" },
  "label.level.undergraduate": { es: "📚 Pregrado", en: "📚 Undergraduate" },
  "label.level.postgraduate": { es: "🎯 Postgrado / Máster", en: "🎯 Postgraduate / Master's" },
  "label.level.doctorate": { es: "🔬 Doctorado", en: "🔬 Doctorate" },
  "label.level.postdoctorate": { es: "🏛️ Postdoctorado", en: "🏛️ Postdoctorate" },
  "label.deadline.all": { es: "📆 Todas", en: "📆 All" },
  "label.deadline.30": { es: "⚡ Cierra en 30 días", en: "⚡ Closes within 30 days" },
  "label.deadline.90": { es: "📅 Cierra en 90 días", en: "📅 Closes within 90 days" },
  "label.deadline.later": { es: "⏳ Más de 90 días", en: "⏳ More than 90 days" },
  "label.sort.deadlineAsc": { es: "⏱️ Cierre más próximo (Inminente)", en: "⏱️ Closing soonest" },
  "label.sort.deadlineDesc": { es: "⏳ Más tiempo para postular", en: "⏳ Most time to apply" },
  "label.sort.supportFirst": { es: "💰 Beca Completa primero", en: "💰 Full scholarships first" },
  "label.sort.titleAsc": { es: "🔤 Nombre (A-Z)", en: "🔤 Name (A-Z)" },
  "label.kind.course": { es: "Cursos", en: "Courses" },
  "label.kind.certificate": { es: "Certificados", en: "Certificates" },
  "label.kind.vet": { es: "Formación Profesional", en: "Vocational Training" },
  "label.route.none": { es: "No abre vía", en: "Does not open a route" },
  "becas.searchPlaceholder": {
    es: "Buscar por nombre, país, área o universidad...",
    en: "Search by name, country, field or university...",
  },

  "label.kindBadge.course": { es: "Curso", en: "Course" },
  "label.kindBadge.certificate": { es: "Certificado", en: "Certificate" },
  "label.kindBadge.vet": { es: "FP", en: "VET" },
  "label.modality.all": { es: "Todas", en: "All" },
  "label.modality.online": { es: "En línea", en: "Online" },
  "label.modality.blended": { es: "Mixta", en: "Blended" },
  "label.modality.inPerson": { es: "Presencial", en: "In person" },
  "label.route.direct": { es: "Abre vía migratoria", en: "Opens a migration route" },
  "label.route.requirement": { es: "Requisito de un visado", en: "Required for a visa" },
  "label.route.unverified": { es: "Sin verificar", en: "Not checked" },
  "label.routeBadge.direct": { es: "Vía migratoria", en: "Migration route" },
